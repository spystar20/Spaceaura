...
<template>
 ...
 <div class="md:p-5 p-2 grid md:grid-cols-[7fr_3fr]  bg-white relative z-10   gap-6 container ">
            <!-- col-1 -->
            <div>
                <div  class=" rounded-2xl md:rounded-4xl   min-h-[calc(100vh-40px)] flex flex-col items-start overflow-hidden  justify-end relative ">
...
<div style="background-image: url(https://i.pinimg.com/1200x/5d/2f/b8/5d2fb87f8c6aacb1d930e01e401f8a05.jpg
                    ...
                    <div
                        ...
                        <span class="md:pr-6 pr-3 pt-4 rounded-tr-lg  bg-white leftText">
            ...
            <!-- col-2 -->
            <div class=" grid grid-rows-2 gap-6 min-h-[calc(100vh-40px)] ">
